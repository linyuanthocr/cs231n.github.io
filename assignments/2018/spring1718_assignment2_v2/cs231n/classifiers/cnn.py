...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        fc_relu_out, fc_relu_cache = affine_relu_forward(conv_out,W2,b2)
        scores, fc_cache = affine_forward(fc_relu_out,W3,b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dfcrelu, grads['W3'], grads['b3'] = affine_backward(d_softmax, fc_cache)
        grads['W3'] += reg*W3
        
        dconv, grads['W2'], grads['b2'] = affine_relu_backward(dfcrelu, fc_relu_cache)
        grads['W2'] += reg*W2        
